...
namespace QQopen\Server;

use QQopen\Core\Exceptions\FaultException;
use QQopen\Core\Exceptions\InvalidArgumentException;
use QQopen\Core\Exceptions\RuntimeException;
use QQopen\Encryption\Encryptor;
use QQopen\Message\AbstractMessage;
use QQopen\Message\Raw as RawMessage;
use QQopen\Message\Text;
use QQopen\Support\Collection;
use QQopen\Support\Log;
use QQopen\Support\Str;
use QQopen\Support\XML;
...
class Guard
{
     ...
     * @return string
     *
     * @throws \QQopen\Core\Exceptions\InvalidArgumentException
     */
     ...
     * @return array
     *
     * @throws \QQopen\Core\Exceptions\RuntimeException
     * @throws \QQopen\Server\BadRequestException
     */
     ...
     *
     * @throws \QQopen\Core\Exceptions\RuntimeException
     * @throws \QQopen\Encryption\EncryptionException
     *
     * @return array
     */
