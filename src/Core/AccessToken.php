...
class AccessToken
{
     ...
     * @var string
     */
    protected $prefix = 'qqopen.common.access_token.';

    // API
    const API_TOKEN_GET = 'https://api.mp.qq.com/cgi-bin/token';
    ...
    /**
     * Get the access token from QQopen server.
     *
