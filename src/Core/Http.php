...
class Http
{
    ...
    public function parseJSON($body)
    {
        ...
        // XXX: json maybe contains special chars. So, let's FUCK the QQopen API developers ...
        $body = $this->fuckTheQQopenInvalidJSON($body);
     ...
     * @return string
     */
    protected function fuckTheQQopenInvalidJSON($invalidJSON)
    {
